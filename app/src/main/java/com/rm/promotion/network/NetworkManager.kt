...
//            AndroidNetworking.post(URL_LOGIN)
//                .addHeaders("Content-Type", "application/json")
//                .addBodyParameter("serialNumber", "PB03203P61521")
//                .addBodyParameter("username", username)
//                .addBodyParameter("password", password)
//                .addBodyParameter("loginType", "1")
//                .addBodyParameter("shift", "")
//                .addBodyParameter("business", "")
//                .setTag("login")
//                .setPriority(Priority.HIGH)
//                .build()
//                .getAsJSONObject(object : JSONObjectRequestListener {
...
//        }
//
//        fun testGetMaster(listener: NetworkLisener<RMDataModel>) {
//            AndroidNetworking.post(URL_GET_DATA_MASTER)
//                .addHeaders("Authorization", "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjcwIiwidXNlcm5hbWUiOiJDMDAxIiwicm9sZV9pZCI6IjEiLCJzdGF0aW9uX2lkIjoiMSIsInNlcmlhbE51bWJlciI6IlBCMTEyMTNKMjEzMzEiLCJhY2Nlc3NUeXBlcyI6WyJnZXRUZWFtcyIsImFkZFRlYW1zIiwidXBkYXRlVGVhbXMiLCJkZWxldGVUZWFtcyJdLCJpYXQiOjE2NjM4MDA2MjUsImV4cCI6MTY2Mzg4NzAyNX0.bAaXcAdvO_bjKZ5lTsASjiL_7w-x-a6vLXKYoTNpjiufZ1JImZM-jmVsSwYCG7p21typxQPc3R7nVKZvlsx8DQ")
//                .addHeaders("Content-type", "application/json")
//                .addHeaders("Accept", "application/json")
//                .addBodyParameter("station_id", "1")
//                .addBodyParameter("mobile_pos_id", "PB03203P61521")//android.os.Build.SERIAL)
...
//                })
//        }
//        fun testCloseShift(obj: JSONObject, listener: NetworkLisener<CloseShiftResponseModel>) {
