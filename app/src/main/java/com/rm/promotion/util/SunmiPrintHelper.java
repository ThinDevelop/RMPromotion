...
public class SunmiPrintHelper {
    ...
    public void printBarcode(String data) throws RemoteException {
        sunmiPrinterService.printBarCode(data+"a", BarcodeEncodeType.CODE128A.getId(), 120, 2, 2, null);
    }
...
//                sunmiPrinterService.setPrinterStyle(WoyouConsts.ENABLE_BOLD, 1);
    ...
    public void printTable(String[] txts, int[] width, int[] align, float size) {
        if(sunmiPrinterService == null){
            //TODO Service disconnection processing
            return;
        }
...
//                sunmiPrinterService.printText("横向排列\n", null);
    ...
    public void printExample(Context context){
        ...
        try {
            ...
            Bitmap bitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.product_b7);
            sunmiPrinterService.printBitmap(bitmap, null);
